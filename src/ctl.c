...
CTL_PROTO(opt_prof_time_resolution)
...
static const ctl_named_node_t opt_node[] = {
	...
	{NAME("prof_time_resolution"),	CTL(opt_prof_time_resolution)}
};
...
CTL_RO_NL_CGEN(config_prof, opt_prof_time_resolution,
    prof_time_resolution_mode_names[opt_prof_time_resolution], const char *)
